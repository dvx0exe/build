...
input:focus, select:focus, textarea:focus {
  ...
  background: linear-gradient(135deg, var(--elden-brown) 0%, var(--elden-dark) 100%);
  box-shadow: 
    inset 0 2px 4px rgba(0, 0, 0, 0.3),
...
/* Estilo específico para selects na criação de personagem */
#create-character-section select {
  background: linear-gradient(135deg, var(--elden-dark) 0%, var(--elden-brown) 100%) !important;
  -webkit-appearance: none; /* Remove estilo padrão do WebKit */
  -moz-appearance: none; /* Remove estilo padrão do Firefox */
  appearance: none; /* Remove estilo padrão geral */
  background-color: transparent; /* Garante transparência de fundo padrão */
}

/* Opcional: Adiciona uma seta personalizada para o select */
#create-character-section select::-ms-expand {
  display: none; /* Remove a seta padrão no Internet Explorer */
}

#create-character-section select {
  position: relative;
  background-image: url('data:image/svg+xml;utf8,<svg fill="%23f2e6c9" height="24" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M7 10l5 5 5-5z"/></svg>'); /* Adiciona uma seta personalizada */
...
:root {
  ...
  /* Novo tom de cinza para a barra */
  --elden-gray: #3a3a3a;
...
/* Estilo para selects na seção de criação de personagem */
#create-character-section select {
  background: var(--elden-gray) !important; /* Fundo cinza sólido */
  color: var(--elden-gold) !important; /* Texto dourado para contraste */
  -webkit-appearance: none; /* Remove o estilo padrão do WebKit */
  -moz-appearance: none; /* Remove o estilo padrão do Firefox */
  appearance: none; /* Remove o estilo padrão geral */
  background-image: url('data:image/svg+xml;utf8,<svg fill="%23f2e6c9" height="24" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M7 10l5 5 5-5z"/></svg>'); /* Setinha personalizada */
  background-repeat: no-repeat;
  background-position: right 1rem center;
  background-size: 1.5rem;
  border: 2px solid var(--elden-gray); /* Borda consistente */
  border-radius: 8px; /* Bordas arredondadas */
  padding: 1rem 1.25rem; /* Espaçamento interno */
  font-family: 'Almendra', serif; /* Fonte temática */
  font-size: 1rem; /* Tamanho da fonte */
  width: 100%; /* Largura total */
}

/* Estilo para inputs na seção de criação de personagem */
#create-character-section input {
  background: var(--elden-gray) !important; /* Fundo cinza sólido */
  color: var(--elden-text); /* Cor do texto legível */
  border: 2px solid var(--elden-gray); /* Borda consistente */
  border-radius: 8px; /* Bordas arredondadas */
